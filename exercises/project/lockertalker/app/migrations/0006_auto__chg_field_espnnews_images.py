...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EspnNews.images'
        db.alter_column(u'app_espnnews', 'images', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'EspnNews.images'
        db.alter_column(u'app_espnnews', 'images', self.gf('django.db.models.fields.CharField')(max_length=255))
