...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'News.source' to match new field type.
        db.rename_column(u'app_news', 'source', 'source_id')
        # Changing field 'News.source'
        db.alter_column(u'app_news', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Sources'], null=True))
        # Adding index on 'News', fields ['source']
        db.create_index(u'app_news', ['source_id'])
    ...
    def backwards(self, orm):
        # Removing index on 'News', fields ['source']
        db.delete_index(u'app_news', ['source_id'])


        # Renaming column for 'News.source' to match new field type.
        db.rename_column(u'app_news', 'source_id', 'source')
        # Changing field 'News.source'
        db.alter_column(u'app_news', 'source', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'app.teams': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['app.Sources']", 'symmetrical': 'False'}),
