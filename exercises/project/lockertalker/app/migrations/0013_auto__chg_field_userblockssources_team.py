...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserBlocksSources.team'
        db.alter_column(u'app_userblockssources', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Teams'], to_field='team_id'))

    def backwards(self, orm):

        # Changing field 'UserBlocksSources.team'
        db.alter_column(u'app_userblockssources', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Teams']))

    models = {
        'app.br': {
            'Meta': {'object_name': 'Br'},
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 28, 0, 0)'}),
        ...
        'app.userblockssources': {
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': "orm['app.Teams']", 'to_field': "'team_id'"}),
