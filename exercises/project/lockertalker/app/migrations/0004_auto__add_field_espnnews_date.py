...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EspnNews.date'
        db.add_column(u'app_espnnews', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 20, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EspnNews.date'
        db.delete_column(u'app_espnnews', 'date')
