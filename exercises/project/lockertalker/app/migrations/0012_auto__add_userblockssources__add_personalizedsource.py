...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserBlocksSources'
        db.create_table(u'app_userblockssources', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['app.Sources'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['app.Teams'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['app.Users'])),
        ))
        db.send_create_signal('app', ['UserBlocksSources'])

        # Adding model 'PersonalizedSource'
        db.create_table(u'app_personalizedsource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('p_id', self.gf('django.db.models.fields.IntegerField')(default='')),
            ('source_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
        ))
        db.send_create_signal('app', ['PersonalizedSource'])


    def backwards(self, orm):
        # Deleting model 'UserBlocksSources'
        db.delete_table(u'app_userblockssources')

        # Deleting model 'PersonalizedSource'
        db.delete_table(u'app_personalizedsource')


    models = {
        'app.br': {
            'Meta': {'object_name': 'Br'},
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 27, 0, 0)'}),
        ...
        'app.userblockssources': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': "orm['app.Users']"})
        },
        'app.users': {
